...
class TransactionControllerTest {
    ...
    void shouldGetTransactionById() throws Exception {
        ...
        mockMvc.perform(get("/api/transaction/{eventID}", eventID)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void shouldCreateTransaction() throws Exception {
        ...
        mockMvc.perform(post("/api/transaction")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"eventType\":\"PURCHASE\",\"orderId\":\"" + eventID + "\",\"inventoryId\":\"" + UUID.randomUUID() + "\",\"change\":10}"))
    ...
    void shouldUpdateTransaction() throws Exception {
        ...
        mockMvc.perform(put("/api/transaction/{eventID}", eventID)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"eventType\":\"CHANGE\",\"orderId\":\"" + eventID + "\",\"inventoryId\":\"" + UUID.randomUUID() + "\",\"change\":5}"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.eventType").value("PURCHASE"));
    }
    ...
    void shouldDeleteTransaction() throws Exception {
        ...
        mockMvc.perform(delete("/api/transaction/{eventID}", eventID))
